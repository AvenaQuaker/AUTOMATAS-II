...
namespace AnalizadorLexico
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            SqlConnection cn = new SqlConnection("Server=JAIMEA\\SQLEXPRESS; Database=LYA2; Trusted_Connection=True;");
            cn.Open();
        ...
        public Dictionary<string, string> ConvertirTablaEnDiccionario(DataTable tabla)
        {
            ...
            foreach (DataRow fila in tabla.Rows) {
                //MessageBox.Show(fila["Terminales"].ToString(), fila["No Terminales"].ToString());
                diccionario.Add(fila[1].ToString(), fila[0].ToString());
            }
            return diccionario;
        }
        #endregion
